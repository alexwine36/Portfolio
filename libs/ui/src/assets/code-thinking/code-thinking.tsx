...
export interface CodeThinkingProps extends SVGProps<SVGSVGElement> {
  primaryColor?: string;
}

const StyledCodeThinking = styled.div`
  color: pink;
`;

export function CodeThinking(props: CodeThinkingProps) {
  ...
  return (
    ...
    >
      ...
      />
      <circle cx={428.058} cy={298.224} r={60.307} fill={primaryColor} />
      <path
        ...
        fill="#3f3d56"
      />
      <path fill={primaryColor} d="M888.401 52.282h24.492v24.492h-24.492z" />
      <path
